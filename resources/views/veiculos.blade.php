...
@section('content')
    ...
    <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="text" name="cpf" class="form-control" id="exampleInputPassword1" placeholder="Qual o modelo do seu veículo?">
        </div>
        <div class="form-group">
            <label for="exampleInputPassword1">Ano de fabricação</label>
            <input type="text" name="fabricacao" class="form-control" id="exampleInputPassword1" placeholder="Qual o ano de fabricação?">
          </div>
          <div class="form-group">
            <label for="exampleInputPassword1">Qual a cor</label>
            <input type="text" name="fabricacao" class="form-control" id="exampleInputPassword1" placeholder="Qual a cor do seu veículo?">
          </div>
